...
document.addEventListener("DOMContentLoaded", function () {
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-info add-to-cart-btn" data-isbn="${knjiga.isbn}">Dodaj u korpu</button>
        ...
        booksRef.on("value", (snapshot) => {
            ...
            addToCartButtons.forEach((button) => {
                button.addEventListener("click", function () {
                    ...
                    const selectedBook = findBookByIsbn(isbn);

                    if (selectedBook) {
                        cart.push(selectedBook);
                        alert("Knjiga je dodata u korpu.");
                    } else {
    ...
    function updateCartCount() {
        ...
        if (cartCount) {
            cartCount.innerText = cart.length.toString(); // Update the cart count display
        }
    }
